...
//	"dunst", NULL,
//	"picom", NULL,
  	"sh", "-c", "bash $HOME/sucklessToolsConfig/conky/conky-startup.sh", NULL,
  	...
  	"sh", "-c", "/usr/bin/emacs --deamon &", NULL,
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_space,  resetmfact,     {0} },
